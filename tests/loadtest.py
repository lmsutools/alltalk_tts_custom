...
async def tts_request(session, text, voice, language, output_file):
    ...
    streaming_url = f"https://7ba301f55a0c1.notebooksc.jarvislabs.net/api/tts-generate-streaming?text={encoded_text}&voice={voice}&language={language}&output_file={output_file}"
